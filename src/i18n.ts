...
export const i18n: Record<Lang, Dict> = {
  th: {
    ...
    demoUploading: "อัปโหลดไฟล์ kyrin-paper.pdf เข้าสู่ระบบแล้วค่ะ",
    demoSummary:
    ...
    githubLabel: "GitHub",
    sampleAnswers: [
      "กำลังรวบรวมหลักฐานจากเอกสารของคุณ แล้วจะสรุปให้ทันทีค่ะ",
      "เจอแหล่งอ้างอิงที่ตรงกับคำถามแล้ว กำลังจัดระเบียบคำตอบค่ะ",
      "นี่คือคำตอบที่อ้างอิงจากเอกสารในคลังของคุณเองค่ะ",
    ],
    greetTriggers: GREET_TRIGGERS,
    greetAnswers: [
      "สวัสดีค่ะ ยินดีต้อนรับสู่ Kyrin Research OS — มีอะไรให้ช่วยได้บ้างไหมคะ?",
      "สวัสดีค่ะ พร้อมช่วยค้นคว้าเอกสารให้คุณแล้ว — ถามอะไรก็ได้เลยนะคะ",
    ],
    testTriggers: TEST_TRIGGERS,
    testAnswers: [
      "รับทราบค่ะ ทดสอบสำเร็จ! ระบบ Kyrin ทำงานปกติ พร้อมให้บริการค่ะ",
      "ระบบพร้อมใช้งานค่ะ! ข้อความของคุณมาถึงเรียบร้อย — ถามอะไรเพิ่มเติมได้เลยนะคะ",
    ],
